...
def evaluation_loop(
    ...
    for step, inputs in enumerate(dataloader):
        ...
        # print(logits[0].argmax(dim=-1), logits[0].size())
        # print(logits[0].size(), logits[1].size())
...
def prediction_step(
    ...
    print(inputs["decoder_input_ids"])
    ...
    with torch.no_grad():
        ...
        if has_labels:
            if self.label_smoother is not None:
                print("LAB", inputs["labels"].size())
                print("OUT", outputs[0].size())
